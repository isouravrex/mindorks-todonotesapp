...
class AddNotesActivity : AppCompatActivity() {
    ...
    lateinit var  buttonSumit: Button
    ...
    private fun clickListeners(){
        ...
        buttonSumit.setOnClickListener(object  : View.OnClickListener{
            override fun onClick(v: View?) {
                val intent = Intent()
    ...
    private fun createImage(): File? {
        val timeFormat = SimpleDateFormat("yyyyMMddHHmmss").format(Date())
        val fileName = "JPEG_"+timeFormat+"_"
    ...
    private fun bindViews() {
        ...
        buttonSumit = findViewById(R.id.buttonSubmit)
